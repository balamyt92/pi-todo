...
/**
 * Состояние целиком для данной сессии. Тип `TaskState` сделан readonly,
 * поэтому читатели не могут мутировать ячейку — обещание комментария держит
 * компилятор, а не договорённость. Для неизвестной сессии — пустой список.
 */
